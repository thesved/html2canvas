                                    ...
                                    switch (_h.label) {
                                        ...
                                        case 4:
                                            if (image) {
                                                ...
                                                //    path[i] = new Vector(((path[i] as Vector).x-this.options.x)*this.options.scale, ((path[i] as Vector).y-this.options.y)*this.options.scale);
                                                path = path.map(function (v) {
                                                    return new Vector((v.x - _this.options.x) * _this.options.scale, (v.y - _this.options.y) * _this.options.scale);
                                                });
                                                x = (x - this_1.options.x) * this_1.options.scale;
                                                y = (y - this_1.options.y) * this_1.options.scale;
                                                width *= this_1.options.scale;
                                                height *= this_1.options.scale;
                                                // backup context and change to null transform
                                                this_1.ctx.save();
                                                this_1.ctx.setTransform(1, 0, 0, 1, 0, 0);
